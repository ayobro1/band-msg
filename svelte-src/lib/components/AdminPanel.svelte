...
<div class="hidden md:flex fixed inset-0 bg-black/80 z-[200] items-center justify-center" style="padding-top: env(safe-area-inset-top);" on:click={(e) => { if (!isLoading && e.target === e.currentTarget) onClose(); }}>
